...
! CLEARTEXT READ **************************************************************
!******************************************************************************
subroutine check_paramsfile(matrices,mesh)
...
subroutine read_log(matrices,mesh)
type(data), intent(inout):: matrices
type(mesh_struct), intent(inout) :: mesh
! Input related variables
character(len=150) :: buffer, label
...
! Control file variables
real(dp) :: wlast(3), t_tresh, t1, t2, tf, wtest(3), w_av(3), Rab(3,3)
integer :: Nmax, firstlineno,lastlineno, i, n1, n2
